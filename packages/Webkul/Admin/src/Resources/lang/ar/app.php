...
return [
	...
	'dashboard' => [
		'index' => [
			...
			'color'                       => 'لون',
			'customer-with-most-sales'    => 'الزبائن الأكثر شراءً',
			'customer-info'               => 'لم يتم العثور على زبائن بأكبر مبيعات',
	...
	'sales' => [
		'orders' => [
			...
			'view' => [
				...
				'customer-notified'     => ':date | الزبون <b>تم إعلامه</b>',
				'customer-not-notified' => ':date | الزبون <b>لم يتم إعلامه</b>',
				...
				'sub-total'             => 'المجموع الجزئي - :sub_total',
				'summary-sub-total'     => 'المجموع الجزئي',
				'summary-tax'           => 'الضريبة',
		...
		'invoices' => [
			...
			'view' => [
				...
				'sku'                    => 'الرمز - :sku',
				'sub-total'              => 'المجموع الجزئي - :sub_total',
				'sub-total-summary'      => 'المجموع الجزئي',
	...
	'catalog' => [
			...
			'edit' => [
				...
				'price' => [
					'group' => [
						...
						'edit-btn'                  => 'تعديل',
						'empty-info'                => 'تسعير خاص للزبائن الذين ينتمون إلى مجموعة معينة.',
						'fixed-group-price-info'    => 'لـ :qty كمية بسعر ثابت قدره :price',
						'title'                     => 'أسعار مجموعة الزبائن',

						'create' => [
							'all-groups'     => 'جميع المجموعات',
							'create-title'   => 'إنشاء سعر مجموعة الزبائن',
							'customer-group' => 'مجموعة الزبائن',
							'discount'       => 'الخصم',
							'delete-btn'     => 'حذف',
							'fixed'          => 'ثابت',
							...
							'qty'            => 'الكمية',
							'save-btn'       => 'حفظ',
							'update-title'   => 'تحديث سعر مجموعة الزبائن',
						],
					],
				],
				...
				'links' => [
					'related-products' => [
						...
						'info'       => 'بالإضافة إلى المنتج الذي يشاهده الزبون، يتم عرض منتجات ذات صلة لهم.',
				...
				'types' => [
					...
					'bundle' => [
						...
						'image-placeholder' => 'صورة المنتج',
						'info'              => 'المنتج المجمع هو حزمة من العناصر أو الخدمات المتعددة التي تُباع معًا بسعر خاص، مما يوفر القيمة والراحة للزبائن.',
						'title'             => 'عناصر الحزم',
		...
		'categories'  => [
			...
			'edit' => [
				...
				'meta-keywords'            => 'الكلمات الرئيسية للوسائط',
				'meta-title'               => 'العنوان الرئيسي للوسائط',
				'position'                 => 'الموضع (الترتيب ضمن الفئات لنفس الأب)',
				'products-and-description' => 'المنتجات والوصف',
				'products-only'            => 'المنتجات فقط',
				'save-btn'                 => 'حفظ الفئة',
				'slug'                     => 'Slug',
				'settings'                 => 'الإعدادات',
				'seo-details'              => 'تفاصيل SEO',
				'select-parent-category'   => 'الفئة الأب*',
				'select-display-mode'      => 'حدد وضع العرض',
				'title'                    => 'تعديل الفئة',
				'visible-in-menu'          => 'نشط',
			],
		...
		'customers' => [
			'index' => [
				...
				'datagrid' => [
					...
					'order-pending'  => 'الزبون لديه طلبات معلقة',
					'partial-action' => 'تمت بعض الإجراءات بنجاح نظرًا لقيود النظام على :resource',
					'update-success' => 'تم تحديث الزبائن المحددين بنجاح',
					'no-resource'    => 'المورد المقدم غير كافٍ للإجراء',
					'method-error'   => 'خطأ! تم اكتشاف طريقة خاطئة، يرجى التحقق من تكوين الإجراء الجماعي',
				],
				...
				'create' => [
					...
					'customer-group'        => 'مجموعة الزبائن',
					'create-success'        => 'تم إنشاء الزبون بنجاح',
					...
					'select-customer-group' => 'اختر مجموعة الزبائن',
					'title'                 => 'إنشاء عميل جديد',
				],
			],

			'delete-success' => 'تم حذف الزبون بنجاح',
			'delete-failed'  => 'فشل حذف الزبون',
			'update-success' => 'تم تحديث الزبون بنجاح',
		...
		'promotions' => [
			...
			'cart-rules' => [
				...
				'create' => [
					...
					'name'                                      => 'الاسم',
					'description'                               => 'الوصف',
					'customer-groups'                           => 'مجموعات الزبائن',
					'channels'                                  => 'القنوات',
					...
					'uses-per-customer-control-info'            => 'سيتم استخدامها للزبائن المسجلين فقط.',
					'conditions'                                => 'الشروط',
			...
			'catalog-rules' => [
				'index' => [
					'title'      => 'قوانين المنتجات',
					'create-btn' => 'إنشاء قاعدة المنتجات',
				...
				'create' => [
					'back-btn'                 => 'رجوع',
					'title'                    => 'إنشاء قاعدة المنتجات',
					'save-btn'                 => 'حفظ قاعدة المنتجات',
					'general'                  => 'عام',
					'name'                     => 'الاسم',
					'description'              => 'الوصف',
					'channels'                 => 'القنوات',
				...
				'create-success' => 'تم إنشاء قاعدة المنتجات بنجاح',
				'delete-success' => 'تم حذف قاعدة المنتجات بنجاح',
				'update-success' => 'تم تحديث قاعدة المنتجات بنجاح',
			],
	...
	'reporting' => [
		...
		'customers' => [
			'index' => [
				'count'                       => 'العدد',
				'customers'                   => 'الزبائن',
				'customers-over-time'         => 'الزبائن مع مرور الوقت',
				'customers-traffic'           => 'حركة الزبائن',
				'customers-with-most-orders'  => 'الزبائن بأكبر عدد من الطلبات',
				'customers-with-most-reviews' => 'الزبائن بأكبر عدد من التقييمات',
				'customers-with-most-sales'   => 'الزبائن بأكبر عدد من المبيعات',
				'email'                       => 'البريد الإلكتروني',
				'end-date'                    => 'تاريخ الانتهاء',
				'id'                          => 'المعرف',
				'interval'                    => 'الفاصل الزمني',
				...
				'start-date'                  => 'تاريخ البدء',
				'title'                       => 'الزبائن',
				'top-customer-groups'         => 'أفضل مجموعات الزبائن',
				'total'                       => 'الإجمالي',
				'total-customers'             => 'إجمالي الزبائن',
		...
		'index' => [
			...
			'general' => [
				...
				'general' => [
					...
					'unit-options' => [
						...
						'title-info'        => 'الحجم، اللون، المادة، التخصيص، تعزيز رضا الزبائن وتصميم المشتريات.',
			...
			'catalog' => [
				...
				'products' => [
					...
					'guest-checkout' => [
						...
						'title'                     => 'الشراء كضيف',
						'title-info'                => 'السماح للزبائن بشراء المنتجات دون إنشاء حساب، مما يبسط عملية الشراء لتوفير الوقت والمرونة.',
					],
					...
					'storefront' => [
						'buy-now-button-display' => 'السماح للزبائن بشراء المنتجات مباشرةً',
						...
						'title'                  => 'واجهة المتجر',
						'title-info'             => 'واجهة المتجر هي واجهة الزبون الرئيسية للمتجر عبر الإنترنت، حيث يتم عرض المنتجات والفئات وخيارات التصفح لتوفير تجربة تسوق سلسة.',
					],
			...
			'email' => [
				...
				'email-settings' => [
					...
					'email-sender-name-tip'  => 'سيتم عرض هذا الاسم في صندوق الوارد للزبائن',
			...
			'sales' => [
				...
				'shipping-methods' => [
					...
					'free-shipping' => [
						...
						'status'                    => 'الحالة',
						'title-info'                => 'الشحن المجاني يشير إلى طريقة الشحن التي يتم تخفيض تكلفة الشحن فيها، ويتكفل البائع بتكاليف الشحن لتوصيل البضائع إلى الزبون.',
						'title'                     => 'العنوان',
					],
					...
					'flat-rate-shipping' => [
						...
						'status'      => 'الحالة',
						'type'        => 'النوع',
						'title-info'  => 'الشحن بسعر ثابت هو طريقة شحن يتم فيها تحصيل رسوم ثابتة للشحن، بغض النظر عن وزن أو حجم أو مسافة الطرد. وهذا يبسط تكاليف الشحن ويمكن أن يكون مفيدًا لكل من البائعين والزبائن.',
						'title'       => 'العنوان',
					],
				],
				...
				'payment-methods' => [
					...
					'cash-on-delivery-info'          => 'وسيلة دفع يقوم فيها الزبائن بدفع المبلغ نقدًا عند استلام البضائع أو الخدمات على عتبة بابهم.',
					'description'                    => 'الوصف',
					'title'                          => 'العنوان',
					...
					'paypal-standard-info'           => 'PayPal القياسي هو خيار دفع PayPal الأساسي للأعمال عبر الإنترنت، مما يتيح للزبائن الدفع باستخدام حسابات PayPal الخاصة بهم أو ببطاقات الائتمان/الخصم.',
					...
					'client-id'                      => 'معرف الزبون',
					'client-id-info'                 => 'استخدم "sb" للفحص.',
					'client-secret'                  => 'السر الخاص الزبون',
				...
				'order-settings' => [
					...
					'order-number' => [
						...
						'title-info' => 'معرِّف فريد يُخصَّص لطلب الزبون الخاص، مما يساعد في تتبع الطلب والاتصال والإشارة إليه طوال عملية الشراء.',
					],
		...
		'layouts' => [
			'header' => [
				...
				'mega-search' => [
					...
					'explore-all-matching-customers'  => 'استكشاف جميع الزبائن المطابقين لـ \":query\" (:count)',
					'explore-all-customers'           => 'استكشاف جميع الزبائن',
					'orders'                          => 'الطلبات',
					'products'                        => 'المنتجات',
					'sku'                             => 'SKU: :sku',
					'title'                           => 'بحث متقدم',
