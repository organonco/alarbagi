        ...
        <div class="flex gap-[10px] mt-[14px] max-xl:flex-wrap">
            ...
            <div class="flex flex-col gap-[8px] flex-1 max-xl:flex-auto">
                        ...
                        @foreach ($order->items as $item)
                            <div
                                ...
                                <div class="flex gap-[10px]">
                                    ...
                                    <div class="grid gap-[6px] place-content-center">
                                ...
                                <div class="grid gap-[4px] place-content-center">
                                    ...
                                    <div class="">
                                        <p
                                            ...
                                            {{ core()->formatBasePrice($item->base_total) }} Total
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-[4px] box-shadow">
                    <div class="flex justify-between p-[16px]">
                        <p class="text-[16px] text-gray-800 dark:text-white font-semibold mb-[16px]">
                            Sub Orders ({{ count($order->sellerOrders) }})
                        </p>
                    </div>
                            ...
                            <div
                                ...
                                <div class="flex gap-[10px]">
                                    ...
                                    <div class="grid gap-2 place-content-start">
                                        ...
                                        <span
                                            class="label-{{ trans('marketplace::app.seller-order.statuses.' . $seller_order->status->name . '.class') }} text-[14px] mb-1">
                                        ...
                                        @if ($seller_order->hasPackage())
                                            <a class="text-gray-600 text-[16px]"
                                                href="{{ route('admin.delivery.packages.view', $seller_order->package->hash) }}"
                                                target="_blank">
                                                Package #{{ $seller_order->package->hash }}
                                            </a>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="grid gap-[4px] place-content-center">
                                    ...
                                    <div class="">
                                        <p
                                            class="flex items-center gap-x-[4px] justify-end text-[16px] text-gray-800 dark:text-white font-semibold">
                                            {{ core()->formatBasePrice($seller_order->grand_total) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-[16px]">
                            <div class="mb-[10px]">
                                <x-admin::form.control-group>
                                    <x-admin::form.control-group.control type="textarea" name="comment" id="comment"
                                        rules="required" :label="trans('admin::app.sales.orders.view.comments')" :placeholder="trans('admin::app.sales.orders.view.write-your-comment')" rows="3">
                            ...
                            <div class="flex justify-between items-center">
                                <label class="flex gap-[4px] w-max items-center p-[6px] cursor-pointer select-none"
                                    for="customer_notified">
                                    <input type="checkbox" name="customer_notified" id="customer_notified"
                                        value="1" class="hidden peer">

                                    <span
                                        class="icon-uncheckbox rounded-[6px] text-[24px] cursor-pointer peer-checked:icon-checked peer-checked:text-blue-600 "></span>

                                    <p
                                        class="flex gap-x-[4px] items-center cursor-pointer text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 font-semibold">
                        ...
                        <div class="grid gap-[6px] p-[16px]">
                            ...
                            <p class="flex gap-2 text-gray-600 dark:text-gray-300 items-center">
                                @if ($comment->customer_notified)
                                    <span
                                        class="h-fit text-[24px] rounded-full icon-done text-blue-600 bg-blue-100"></span>

                                    @lang('admin::app.sales.orders.view.customer-notified', ['date' => core()->formatDate($comment->created_at, 'Y-m-d H:i:s a')])
                                @else
                                    <span
                                        class="h-fit text-[24px] rounded-full icon-cancel-1 text-red-600 bg-red-100"></span>
