<div>
    <div v-if="! forms.billing.isNew">
        <x-shop::accordion class="!border-b-[0px]">
            ...
            <x-slot:content>
                <v-form @submit.preventDefault v-slot="{ meta, errors }">
                    <div
                        ...
                        <div class="relative max-w-[414px] p-[0px] border border-[#e5e5e5] rounded-[12px] max-sm:flex-wrap select-none cursor-pointer"
                            ...
                            <v-field type="radio" name="billing[address_id]" :value="address.id"
                                :id="'billing_address_id_' + address.id" class="hidden peer"
                                :rules="{ required: !isTempAddress }" label="@lang('shop::app.checkout.onepage.addresses.billing.billing-address')"
                                v-model="forms.billing.address.address_id" :checked="address.isDefault"
                            ...
                            <label :for="'billing_address_id_' + address.id"
                    ...
                    <v-error-message class="text-red-500 text-xs italic" name="billing[address_id]">
                    </v-error-message>

                    <div class="flex gap-x-[15px] mt-[20px] text-[14px] text-[#6E6E6E] select-none">
                        <input type="checkbox" id="isUsedForShipping" name="is_use_for_shipping" class="hidden peer"
                        ...
                        <label for="isUsedForShipping" class="cursor-pointer">
                    ...
                    <template v-if="meta.valid">
                        <div v-if="! forms.billing.isNew && ! forms.shipping.isNew && forms.billing.isUsedForShipping">
                            <div class="flex justify-end mt-4 mb-4">
                                <button class="sn-button-primary" @click="store">
                ...
                <x-shop::form v-slot="{ meta, errors, handleSubmit }" as="div">
                    <form @submit="handleSubmit($event, handleBillingAddressForm)">
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" name="billing[company_name]"
                                :label="trans('shop::app.checkout.onepage.addresses.billing.company-name')" :placeholder="trans('shop::app.checkout.onepage.addresses.billing.company-name')" v-model="forms.billing.address.company_name">
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="email" name="billing[email]"
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" name="billing[address1][]"
                                rules="required" :label="trans('shop::app.checkout.onepage.addresses.billing.street-address')" :placeholder="trans('shop::app.checkout.onepage.addresses.billing.street-address')"
                                v-model="forms.billing.address.address1[0]">
                            </x-shop::form.control-group.control>

                            <x-shop::form.control-group.error class="mb-2" control-name="billing[address1][]">
                            </x-shop::form.control-group.error>

                            @if (core()->getConfigData('customer.address.information.street_lines') > 1)
                                @for ($i = 1; $i < core()->getConfigData('customer.address.information.street_lines'); $i++)
                                    <x-shop::form.control-group.control type="text"
                                        name="billing[address1][{{ $i }}]" :label="trans('shop::app.checkout.onepage.addresses.billing.street-address')"
                        ...
                        <div class="grid grid-cols-2 gap-x-[20px]">
                            <x-shop::form.control-group class="!mb-4">
                                ...
                                <x-shop::form.control-group.control type="select" name="billing[country]"
                                    class="py-2 mb-2" rules="required" :label="trans('shop::app.checkout.onepage.addresses.billing.country')" :placeholder="trans('shop::app.checkout.onepage.addresses.billing.country')"
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="billing[state]"
                                    rules="required" :label="trans('shop::app.checkout.onepage.addresses.billing.state')" :placeholder="trans('shop::app.checkout.onepage.addresses.billing.state')"
                                    v-model="forms.billing.address.state" v-if="! haveStates('billing')">
                                </x-shop::form.control-group.control>

                                <x-shop::form.control-group.control type="select" name="billing[state]"
                                    class="py-2 mb-2" rules="required" :label="trans('shop::app.checkout.onepage.addresses.billing.state')" :placeholder="trans('shop::app.checkout.onepage.addresses.billing.state')"
                                    v-model="forms.billing.address.state" v-if="haveStates('billing')">
                                    <option value="">@lang('shop::app.checkout.onepage.addresses.billing.select-state')</option>

                                    <option v-for='(state, index) in states[forms.billing.address.country]'
                                        :value="state.code">
                                        @{{ state.default_name }}
                                    </option>
                                </x-shop::form.control-group.control>
                        ...
                        <div class="grid grid-cols-2 gap-x-[20px]">
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="billing[postcode]"
                                    rules="required" :label="trans('shop::app.checkout.onepage.addresses.billing.postcode')" :placeholder="trans('shop::app.checkout.onepage.addresses.billing.postcode')"
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" name="billing[phone]"
                            ...
                            <div class="grid gap-[10px]">
                                @auth('customer')
                                    <div class="select-none flex gap-x-[15px]">
                                        <input type="checkbox" name="billing[default_address]"
                                            id="billing[default_address]" class="hidden peer"
