                ...
                <x-shop::form v-slot="{ meta, errors, handleSubmit }" as="div">
                    <form @submit="handleSubmit($event, handleShippingAddressForm)">
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="select" name="shipping[area_id]" class="py-2 mb-2"
                                ...
                                <option v-for="area in areas" :value="area.id" v-text="area.name + (area.is_shippable ? '' : ' - التوصيل غير متاح') ">
                                </option>
                            </x-shop::form.control-group.control>
                        ...
                        <x-shop::form.control-group class="!mb-4">
                            ...
                            <x-shop::form.control-group.control type="textarea" name="shipping[address_details]"
                                :label="trans('shop::app.checkout.onepage.addresses.shipping.address_details')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.address_details')"
                                v-model="forms.shipping.address.address_details">
                            </x-shop::form.control-group.control>
