                    ...
                    <form @submit="handleSubmit($event, store)">
                        <div
                            ...
                            <div class="relative max-w-[414px] p-[0px] border border-[#e5e5e5] rounded-[12px] max-sm:flex-wrap select-none cursor-pointer"
                                ...
                                <label
                                    class="icon-radio-unselect absolute ltr:right-[20px] rtl:left-[20px] top-[20px] text-[24px] peer-checked:icon-radio-select cursor-pointer sn-color-light-main"
                        ...
                        <template v-if="meta.valid">
                            <div
                                v-if="! forms.billing.isNew && ! forms.shipping.isNew && ! forms.billing.isUsedForShipping">
                ...
                <x-shop::form v-slot="{ meta, errors, handleSubmit }" as="div">
                    <form @submit="handleSubmit($event, handleShippingAddressForm)">
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" name="shipping[company_name]"
                                :label="trans('shop::app.checkout.onepage.addresses.shipping.company-name')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.company-name')" v-model="forms.shipping.address.company_name">
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="email" name="shipping[email]"
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" name="shipping[address1][]"
                                rules="required" :label="trans('shop::app.checkout.onepage.addresses.shipping.street-address')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.street-address')"
                                v-model="forms.shipping.address.address1[0]">
                            </x-shop::form.control-group.control>

                            <x-shop::form.control-group.error class="mb-2" control-name="shipping[address1][]">
                            </x-shop::form.control-group.error>

                            @if (core()->getConfigData('customer.address.information.street_lines') > 1)
                                @for ($i = 1; $i < core()->getConfigData('customer.address.information.street_lines'); $i++)
                                    <x-shop::form.control-group.control type="text"
                                        name="shipping[address1][{{ $i }}]" :label="trans(
                                            'shop::app.checkout.onepage.addresses.shipping.street-address',
                                        )"
                                        :placeholder="trans(
                                            'shop::app.checkout.onepage.addresses.shipping.street-address',
                                        )"
                        ...
                        <div class="grid grid-cols-2 gap-x-[20px]">
                            <x-shop::form.control-group class="!mb-4">
                                ...
                                <x-shop::form.control-group.control type="select" name="shipping[country]"
                                    class="py-2 mb-2" rules="required" :label="trans('shop::app.checkout.onepage.addresses.shipping.country')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.country')"
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="shipping[state]"
                                    rules="required" :label="trans('shop::app.checkout.onepage.addresses.shipping.state')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.state')"
                                    v-model="forms.shipping.address.state" v-if="! haveStates('shipping')">
                                </x-shop::form.control-group.control>

                                <x-shop::form.control-group.control type="select" name="shipping[state]"
                                    class="py-2 mb-2" rules="required" :label="trans('shop::app.checkout.onepage.addresses.shipping.state')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.state')"
                                    v-model="forms.shipping.address.state" v-if="haveStates('shipping')">
                                    <option value="">@lang('shop::app.checkout.onepage.addresses.shipping.select-state')</option>

                                    <option v-for='(state, index) in states[forms.shipping.address.country]'
                                        :value="state.code">
                                        @{{ state.default_name }}
                                    </option>
                                </x-shop::form.control-group.control>
                        ...
                        <div class="grid grid-cols-2 gap-x-[20px]">
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="shipping[postcode]"
                                    rules="required" :label="trans('shop::app.checkout.onepage.addresses.shipping.postcode')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.postcode')"
