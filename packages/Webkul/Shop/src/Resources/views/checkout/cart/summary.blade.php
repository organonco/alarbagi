<div class="w-[418px] max-w-full">
    ...
    <div class="grid gap-[15px] mt-[25px]">
        <div class="flex justify-between text-right">
            ...
            <p class="text-[16px] font-medium" v-text="cart.formatted_sub_total">
            </p>
        </div>

        <div class="flex justify-between text-right" v-for="(amount, index) in cart.base_tax_amounts"
            ...
            <p class="text-[16px] font-medium max-sm:text-[14px] max-sm:font-medium" v-text="amount">
            </p>
        </div>
        ...
        <div class="flex justify-between text-right"
            ...
            <p class="text-[16px] font-medium" v-text="cart.formatted_base_discount_amount">
            </p>
        </div>
        ...
        <div class="flex justify-between text-right">
            ...
            <p class="text-[18px] font-semibold" v-text="cart.formatted_grand_total">
            </p>
        </div>
