<x-shop::layouts.account>
    ...
    <x-shop::form :action="route('shop.customers.account.addresses.store')" class="rounded mt-[30px]">
        ...
        <x-shop::form.control-group class="mb-4">
            ...
            <x-shop::form.control-group.control type="text" name="company_name" :value="old('company_name')" :label="trans('shop::app.customers.account.addresses.company-name')"
        ...
        <x-shop::form.control-group class="mb-4">
            ...
            <x-shop::form.control-group.control type="text" name="first_name" :value="old('first_name')" rules="required"
        ...
        <x-shop::form.control-group class="mb-4">
            ...
            <x-shop::form.control-group.control type="text" name="last_name" :value="old('last_name')" rules="required"
        ...
        <x-shop::form.control-group class="mb-4">
            ...
            <x-shop::form.control-group.control type="text" name="address1[]" :value="old('address1[]')" rules="required"
        ...
        @if (core()->getConfigData('customer.address.information.street_lines') &&
            ...
            @for ($i = 2; $i <= core()->getConfigData('customer.address.information.street_lines'); $i++)
                <x-shop::form.control-group.control type="text" name="address{{ $i }}[]"
                    :value="old('address{{ $i }}[]')" :label="trans('shop::app.customers.account.addresses.street-address')" :placeholder="trans('shop::app.customers.account.addresses.street-address')">
                </x-shop::form.control-group.control>
            @endfor
        @endif
        ...
        <x-shop::form.control-group class="mb-4">
            ...
            <x-shop::form.control-group.control type="select" name="country" :value="old('country')" class="mb-4"
        ...
        <x-shop::form.control-group class="mb-4">
            ...
            <x-shop::form.control-group.control type="text" name="state" :value="old('state')" rules="required"
        ...
        <x-shop::form.control-group class="mb-4">
            ...
            <x-shop::form.control-group.control type="text" name="city" :value="old('city')" rules="required"
        ...
        <x-shop::form.control-group class="mb-4">
            ...
            <x-shop::form.control-group.control type="text" name="postcode" :value="old('postcode')"
        ...
        <div class="flex gap-x-[15px] mb-4 select-none">
            ...
            <label class="block text-[16px] cursor-pointer" for="default_address">
