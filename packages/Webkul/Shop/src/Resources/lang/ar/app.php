...
return [
	...
	'customers' => [
		'forgot-password' => [
			...
			'phone-not-exist' => 'لا يمكننا العثور على مستخدم بهذا الرقم',
			'phone' => 'رقم الهاتف',
			'forgot-password-text' => 'إذا نسيت كلمة المرور الخاصة بك، يمكنك استعادتها عن طريق إدخال عنوان رقم الهاتف الخاص بك.',
			'footer' => '',
			'page-title' => 'هل نسيت كلمة المرور؟',
			'reset-link-sent' => 'تم إرسال رمز التحقق الى رقم الهاتف الخاص بك.',
		...
		'reset-password' => [
			...
			'text' => 'ستصلك رسالة SMS فيها رمز التحقق',
		],
		...
		'login-form' => [
			...
			'phone' => 'رقم الهاتف',
			'form-login-text' => [
				'first' => 'قم بتسجيل الدخول لحساب المستخدم الخاص بك أو',
				'last' => 'تسجيل الدخول كبائع'
			],
			'footer' => '',
			'forgot-pass' => 'هل نسيت كلمة المرور؟',
			'invalid-credentials' => 'يرجى التحقق من بيانات الحساب والمحاولة مرة أخرى.',
			'not-activated' => 'تم تجميد حسابك، يرجى التواصل مع الإدارة',
			'new-customer' => 'مستخدم جديد؟',
			'page-title' => 'تسجيل الدخول ',
			'password' => 'كلمة المرور',
			'show-password' => 'عرض كلمة المرور',
			'title' => 'تسجيل الدخول',
			'verify-first' => 'الرجاء تأكيد رقم الهاتف الخاص بك أولاً.',
		],

		'signup-form' => [
			'account-exists' => 'هل لديك حساب؟',
			...
			'page-title' => 'التسجيل كمستخدم',
			'password' => 'كلمة المرور',
			'sign-in-button' => 'تسجيل الدخول',
			'subscribe-to-newsletter' => 'الاشتراك في النشرة الإخبارية',
			'success-verify' => 'تم إرسال رمز التحقق لرقم الهاتف للتأكيد',
			'success-verify-email-unsent' => 'تم إنشاء الحساب بنجاح، ولكن رسالة التأكيد لم تتم إرسالها.',
			...
			'license' => "صورة الرخصة",
			'id' => "صورة الهوية الشخصية (أمام)",
			'id-back' => "صورة الهوية الشخصية (خلف)",
			'additional-email' => "بريد الكتروني إضافي",
			'phone' => "رقم الموبايل",
		...
		'account' => [
			...
			'profile' => [
				...
				'delete-success' => 'تم حذف خسابك بنجاح',
				'delete-failed' => 'حدثت مشكلة أثناء حذف الحساب.',
				'delete' => 'حذف',
				'email' => 'البريد الإلكتروني',
			...
			'addresses' => [
				...
				'address-details' => 'تفاصيل العنوان (مطلوبة في اختيار مع توصيل)',
				'address-1' => 'العنوان 1',
				'address-2' => 'العنوان 2',
				'city' => 'المدينة',
				'country' => 'البلد',
				'create-success' => 'تمت إضافة العنوان بنجاح.',
				'company-name' => 'اسم الشركة / رقم المنزل / رقم الشقة',
				'delete' => 'حذف',
			...
			'orders' => [
				...
				'view' => [
					...
					'information' => [
						...
						'item-refunded' => 'تم استرداده (:qty_refunded)',
					...
					'shipments' => [
						'individual-shipment' => 'شحنة #:shipment_id',
						'product-name' => 'الاسم',
						'qty' => 'الكمية',
						'sku' => 'SKU',
						'shipments' => 'الشحن',
			...
			'wishlist' => [
				'color' => 'اللون',
				'delete-all' => 'حذف الكل',
				'empty' => 'لم يتم إضافة منتجات إلى صفحة قائمة الرغبات',
				'move-to-cart' => 'نقل إلى عربة التسوق',
				'moved-success' => 'تم نقل العنصر بنجاح إلى عربة التسوق',
				'moved' => 'تم نقل العنصر بنجاح إلى عربة التسوق',
				'page-title' => 'قائمة الرغبات',
				'profile' => 'الملف الشخصي',
				'product-removed' => 'المنتج غير متاح بعد الإزالة بواسطة الإدارة',
				'remove' => 'إزالة',
				'removed' => 'تم إزالة العنصر بنجاح من قائمة الرغبات',
	...
	'components' => [
		...
		'layouts' => [
			'header' => [
				...
				'compare' => 'مقارنة',
				'cart' => 'العربة',
				'dropdown-text' => 'إدارة العربة والطلبات ',
				'logout' => 'تسجيل الخروج',
				'orders' => 'الطلبات',
				'profile' => 'الملف الشخصي',
				'sign-in' => 'تسجيل الدخول',
				'sign-up' => 'التسجيل',
				'search-text' => 'ما اللذي تبحث عنه؟',
				'search' => 'بحث',
				'title' => 'الحساب',
				'welcome' => 'أهلاً بك ',
			...
			'footer' => [
				...
				'footer-text' => '',
				'locale' => 'اللغة',
				'newsletter-text' => 'احصل على نشرتنا البريدية!',
		...
		'datagrid' => [
			...
			'table' => [
				'actions' => 'الإجراءات',
				'no-records-available' => 'لا توجد عناصر متاحة.',
			],
		],
	...
	'products' => [
		...
		'view' => [
			...
			'already-in-compare' => 'المنتج مضاف مسبقاً إلى قائمة المقارنة.',
	...
	'categories' => [
		...
		'view' => [
			'empty' => 'لا يتوفر منتجات',
			'empty-sellers' => 'لا يتوفر بائعين تحت هذا  البحث',
			'empty-category' => 'لا يتوفر بائعين تحت هذا  التصنيف',
			'load-more' => 'تحميل المزيد',
		],
	],
	...
	'checkout' => [
		...
		'cart' => [
			...
			'inactive' => 'تم إلغاء تنشيط المنتج وبالتالي إزالته من العربة.',
			...
			'rule-applied' => 'تم تطبيق قاعدة العربة',
			...
			'index' => [
				...
				'empty-product' => 'ليس لديك منتج في عربة التسوق الخاصة بك.',
				'home' => 'الصفحة الرئيسية',
				'items-selected' => ':count عناصر تم تحديدها',
				'move-to-wishlist-success' => 'تم نقل العناصر المحددة بنجاح إلى قائمة الرغبات.',
				...
				'remove' => 'إزالة',
				'remove-selected-success' => 'تم إزالة العناصر المحددة بنجاح من العربة.',
				'see-details' => 'عرض التفاصيل',
				'tax' => 'الضريبة',
				'total' => 'المجموع',
		...
		'onepage' => [
			'addresses' => [
				...
				'shipping' => [
					'add-new-address' => 'إضافة تفاصيل مستلم جديدة',
					'back' => 'رجوع',
					'name' => 'اسم المستلم',
					...
					'shipping-address' => 'تفاصيل الاستلام',
					'save-address' => 'حفظ التفاصيل للاستخدام لاحقاً',
	...
	'errors' => [
		...
		'404' => [
			'description' => 'عذرًا! الصفحة التي تبحث عنها غير متاحة. يبدو أننا لم نتمكن من العثور على ما كنت تبحث عنه.',
	...
	'emails' => [
		...
		'customers' => [
			'registration' => [
				'description' => 'تم إنشاء حسابك بنجاح الآن، ويمكنك تسجيل الدخول باستخدام عنوان بريدك الإلكتروني وكلمة المرور. بمجرد تسجيل الدخول، ستتمكن من الوصول إلى خدمات أخرى بما في ذلك استعراض الطلبات السابقة وقائمة الرغبات وتحرير معلومات حسابك.',
