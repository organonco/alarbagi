...
return [
	...
	'customers' => [
		...
		'login-form' => [
			...
			'title' => 'تسجيل الدخول',
			'verify-first' => 'الرجاء تأكيد البريد الإلكتروني الخاص بك أولاً.',
		],
		...
		'signup-form' => [
			...
			'success-verify' => 'تم إنشاء الحساب بنجاح، تم إرسال رسالة بريد إلكتروني للتأكيد.',
		...
		'onepage' => [
			'addresses' => [
				...
				'shipping' => [
					...
					'area_id' => 'المنطقة (مطلوب في حالة اختيار مع توصيل)',
					'address_details' => 'تفاصيل العنوان (مطلوب في حالة اختيار مع توصيل)',
					'shipping-address' => 'تفاصيل الاستلام',
					'save-address' => 'حفظ التفاصيل للاستخدام لاحقاً',
					'confirm' => 'تأكيد العنوان',
					'location' => 'الموقع على الخريطة (مطلوب في حالة اختيار مع توصيل)'
				],
			],
