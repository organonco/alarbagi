...
return [
	...
	'admin' => [
		...
		'banners' => [
			...
			'create' => [
				'title' => 'إنشاء بنر إعلاني',
				'attributes' => [
					'banner' => 'البنر الإعلاني',
					'mobile' => 'موبايل؟',
					'seller_category_id' => "التصنيف"
				]
			],
			'main' => [
				'title' => 'إنشاء بنر للصفحة الرئيسية',
			],
			'category' => [
				'title' => 'إنشاء بنر للتصنيف',
			],
			'area' => [
				'title' => 'إنشاء بنر للمنطقة',
			],
			'edit' => [
				'title' => 'تعديل البنر الإعلاني'
			]
		]
	],
	'settings' => [
	...
	"notifications" => [
		"OrderUpdated" => "تم تحديث حالة الطلب الخاص بك",
		"OfferCreated" => "تم إضافة عروض خاصة جديدة"
	]
];
