<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.banners.store.category')" enctype="multipart/form-data">
        ...
        <div class="flex gap-[10px] mt-[14px] max-xl:flex-wrap content-center justify-center">
            <div class=" flex flex-col gap-[8px] flex-1 max-xl:flex-auto">
                ...
                <x-admin::form.control-group class="mb-[10px]">
                    ...
                    <x-admin::form.control-group.control type="select" name="area_id">
                ...
                <x-admin::form.control-group class="mb-[10px]">
                    <x-admin::form.control-group.label class="required">
                        @lang('marketplace::app.admin.banners.create.attributes.seller_category_id')
                    </x-admin::form.control-group.label>
                    <x-admin::form.control-group.control type="select" name="seller_category_id">
                        @foreach ($sellerCategories as $id => $name)
                            <option value="{{ $id }}">{{ $name }}</option>
                        @endforeach
                    </x-admin::form.control-group.control>
                    <x-admin::form.control-group.error control-name="seller_category_id">
                    </x-admin::form.control-group.error>
                </x-admin::form.control-group>
