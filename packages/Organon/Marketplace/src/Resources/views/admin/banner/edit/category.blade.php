<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.banners.update.category', $banner->id)" enctype="multipart/form-data">
        ...
        <div class="flex gap-[10px] mt-[14px] max-xl:flex-wrap content-center justify-center">
            <div class=" flex flex-col gap-[8px] flex-1 max-xl:flex-auto">
                ...
                <x-admin::form.control-group class="mb-[10px]">
                    ...
                    <x-admin::form.control-group.control type="select" name="seller_category_id" value="{{$banner->seller_category_id}}">
