            ...
            <div class="flex flex-col gap-[8px] flex-1 max-xl:flex-auto">
                <div class="bg-white dark:bg-gray-900 rounded-[4px] box-shadow">
                    <div class="p-[16px]">
                        ...
                        <x-admin::form :action="route('admin.account.settings.update-settings')">
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label
                                        class="required">@lang('marketplace::app.admin.account.settings.labels.deliver-by')</x-admin::form.control-group.label>
                                <x-admin::form.control-group.control type="number" name="deliver_by"
                                                                     value="{{$seller->deliver_by}}">
                                </x-admin::form.control-group.control>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control type="textarea" name="payment_method" rows="8"
                                                                     value="{{$seller->payment_method}}">
                                </x-admin::form.control-group.control>
                                <x-shop::form.control-group.error
                                        control-name="payment_method"></x-shop::form.control-group.error>
                            </x-admin::form.control-group>
