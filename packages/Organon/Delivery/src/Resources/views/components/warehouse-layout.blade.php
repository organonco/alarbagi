...
<body class="bg-gray-900">
    ...
    <div class="flex flex-row justify-between">
        ...
        @if (!Route::is('warehouse.dashboard'))
    ...
    <aside id="default-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-800 flex flex-col content-between justify-between">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('warehouse.add-package.create') }}"
                        class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                        <svg class="w-5 h-5 transition duration-75 text-gray-400 group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 45 45">
  ...
  c2.283,0,4.134-1.867,4.133-4.15C45.399,20.425,43.548,18.557,41.267,18.557z" />
                        ...
                        <span class="ms-3">Add Package</span>
                    </a>
                </li>
            </ul>
            <form method="POST" action="{{ route('warehouse.session.destroy') }}" id="logout-form">
                <ul class="font-medium hover:cursor-pointer">
                    <li class="mx-1 bg-slate-700 rounded-lg mt-40" onclick="document.forms['logout-form'].submit();">
                        @csrf
    ...
    <div class="p-4 sm:ml-64 flex gap-4 flex-col">
