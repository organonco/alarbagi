...
<body class="bg-gray-900">
    ...
    <aside id="default-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-800 flex flex-col content-between justify-between">
            <div>
                <div class="text-white text-center sn-heading-3 py-4">
                    {{ auth()->guard('shipping')->user()->area->name }}
                </div>
            ...
            <form method="POST" action="{{ route('shipping.session.destroy') }}" id="logout-form">
                <ul class="font-medium hover:cursor-pointer">
                    <li class="mx-1 bg-slate-700 rounded-lg mt-40" onclick="document.forms['logout-form'].submit();">
                        ...
                        <a
                            class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group justify-between px-4">
                            <span class="ms-3 sn-heading-3">تسجيل الخروج</span>
    ...
    <div class="p-4 sm:mr-64 flex gap-4 flex-col">
