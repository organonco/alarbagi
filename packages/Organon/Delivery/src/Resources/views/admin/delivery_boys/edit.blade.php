<x-admin::layouts>
    <x-slot:title>
        {{ __('Edit Delivery Person') }}
    </x-slot:title>

    <x-admin::form :action="route('admin.delivery.delivery_boys.update', $deliveryBoy->id)" enctype="multipart/form-data">
    ...
    <x-admin::form :action="route('admin.delivery.delivery_boys.update_password', $deliveryBoy->id)" enctype="multipart/form-data">
        <div class="flex gap-[10px] mt-[14px] max-xl:flex-wrap">
            <div class=" flex flex-col gap-[8px] flex-1 max-xl:flex-auto">
                <div class="p-[16px] bg-white dark:bg-gray-900 rounded-[4px] box-shadow">
                    <div class="pb-[16px]">
